...
class ULandscapeHeightfieldCollisionComponent : public UPrimitiveComponent
{
	...
	struct FPhysXHeightfieldRef : public FRefCountedObject
	{
		...
		physx::PxShape*		  RBHeightFieldShapeSync;
		physx::PxShape*		  RBHeightFieldShapeSimpleSync;
		physx::PxShape*		  RBHeightFieldShapeAsync;
		physx::PxShape*		  RBHeightFieldShapeSimpleAsync;
#if WITH_EDITOR
		physx::PxHeightField* RBHeightfieldEd; // Used only by landscape editor, does not have holes in it
		physx::PxShape*       RBHeightFieldEdShapeSync;
#endif	//WITH_EDITOR
#endif	//WITH_PHYSX
		...
		FPhysXHeightfieldRef()
			...
			, RBHeightFieldShapeSync(nullptr)
			, RBHeightFieldShapeSimpleSync(nullptr)
			, RBHeightFieldShapeAsync(nullptr)
			, RBHeightFieldShapeSimpleAsync(nullptr)
#if WITH_EDITOR
			, RBHeightfieldEd(nullptr)
			, RBHeightFieldEdShapeSync(nullptr)
#endif	//WITH_EDITOR
#endif	//WITH_PHYSX
		{
		}
