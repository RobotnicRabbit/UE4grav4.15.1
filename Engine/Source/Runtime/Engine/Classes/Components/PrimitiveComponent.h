...
public:
	...
	/** Enables/disables whether this component has a custom gravity. This applies only to components with bSimulatePhysics and bEnableGravity set to true. */
	UFUNCTION(BlueprintCallable, Category = "Physics")
	virtual void SetUseCustomGravity(bool useCustomGravity);
	...
	/** Returns whether this component has a custom gravity. Returns always false if the component is not simulated. */
	UFUNCTION(BlueprintCallable, Category = "Physics")
	virtual bool IsCustomGravityEnabled() const;
	
	/** Return the gravity acting on this component */
	UFUNCTION(BlueprintCallable, Category = "Physics")
	virtual FVector GetGravity() const;
	
	/** Set the custom gravity, will only affect body if bEnableGravity and bUseCustomGravity are true */
	UFUNCTION(BlueprintCallable, Category = "Physics")
