...
public:
	...
	*/
	 ...
	 */
	virtual bool ShouldJumpOutOfWater(FVector& JumpDir, const FVector& GravDir);
	 ...
	 */
	virtual FVector GetFallingLateralAcceleration(float DeltaTime, const FVector& GravDir);
...
protected:
	 ...
	 * @see PhysFalling()
	 */
	virtual FVector LimitAirControl(float DeltaTime, const FVector& FallAcceleration, const FHitResult& HitResult, const FVector& GravDir, bool bCheckForValidLandingSpot);
...
public:
	...
	virtual bool CheckWaterJump(FVector JumpDir, const FVector& GravDir, FVector& WallNormal);
...
protected:
	 ...
	 */
	virtual FVector ComputeGroundMovementDelta(const FVector& Delta, const FVector& DeltaPlaneNormal, const FHitResult& RampHit, const bool bHitFromLineTrace) const;
...
public:
	 ...
	 */
	virtual bool IsWithinEdgeTolerance(const FVector& CapsuleLocation, const FVector& CapsuleDown, const FVector& TestImpactPoint, const float CapsuleRadius) const;
...
protected:
	 ...
	 * Custom gravity.
	 */
	UPROPERTY(Category = "Character Movement: Physics Interaction", EditAnywhere, meta = (editcondition = "bUseCustomGravity"))
...
public:
	 ...
	 */
	UFUNCTION(Category = "Pawn|Components|CharacterMovement", BlueprintCallable)
		virtual void SetCustomGravity(FVector NewGravity);
};
