...
class ENGINE_API AWorldSettings : public AInfo, public IInterface_AssetUserData
{
	...
	/** if set to true, when we call GetGravity we assume WorldGravity has already been initialized and skip the lookup of DefaultGravity and GlobalGravity */
	UPROPERTY(transient)
	uint32 bWorldGravitySet:1;

	/** If set to true, will override the built in DefaultGravity with GlobalGravity */
...
public:
	...
	/**
	 * Returns the current world gravity and initializes it to the default
	...
	/**
	 * Sets the current world gravity using GlobalGravity and sets
	 * bGlobalGravity to true
	 *
	 * @param NewGravity  New world gravity
	 */
	UFUNCTION(BlueprintCallable, Category = "Physics")
	virtual void SetGravity(FVector NewGravity);
