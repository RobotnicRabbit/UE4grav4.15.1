...
// Deprecated
FVector UProjectileMovementComponent::GetEffectiveGravity() const
{
	return GetGravity();
}
...
{
	return bForceSubStepping || (GetGravity() != FVector::ZeroVector) || (bIsHomingProjectile && HomingTargetComponent.IsValid());
}
