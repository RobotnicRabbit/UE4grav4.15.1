...
/** Array of PxHeightFieldGeometry objects stored within PxShape which are awaiting cleaning up. */
extern ENGINE_API TArray<PxShape*>		GPhysXPendingKillHeightfieldGeometry;
